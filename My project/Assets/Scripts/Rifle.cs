...
public class Rifle : MonoBehaviour
{
    ...
    private float nextTurnToShoot = 0f;
   ...
   // public GameObject AmmoOutUI;
    ...
    private void Update()
    {
        ...
        if (Input.GetButton("Fire1") && Time.time >= nextTurnToShoot)
        {
            animator.SetBool("Fire", true);
            animator.SetBool("Idle", false);
            nextTurnToShoot = Time.time + 1f/fireCharge;
            Shoot();
        }
        else if (Input.GetButton("Fire1") && Input.GetKey(KeyCode.W) || Input.GetKey(KeyCode.A) || Input.GetKey(KeyCode.S) || Input.GetKey(KeyCode.D) || Input.GetKey(KeyCode.UpArrow))
        {
            animator.SetBool("Idle",false);
